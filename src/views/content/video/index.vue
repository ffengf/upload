...
import { api_video_list, video_list } from "./api";
import Page from "@/components/page/index.vue";

const List = Mixin_list<video_list>(api_video_list.get_list as any);
// @ts-ignore
@Component({
    components: {
        Page,
...
export default class extends List {
    ...
    async top(row: video_list) {
		await api_video_list.put_top(row)
		this.$message.success('修改成功')
		this.get_list()
    }

    async remove(id: number | string) {
		await api_video_list.remove(id)
